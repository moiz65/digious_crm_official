...
curl -s http://100.114.9.93:5000/api/v1/employees/profile/1/required-documents | jq .
echo ""
echo ""

echo "2. Upload a dynamic document (Medical Certificate):"
curl -s -X POST http://100.114.9.93:5000/api/v1/employees/profile/1/upload-required-documents \
