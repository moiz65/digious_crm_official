                    ...
                    <tr key={`${app.id}-${index}`} className="border-b border-slate-100 hover:bg-slate-50">
                      ...
                      <td className="py-4 px-6">
                        <div>
                          ...
                          <p className="text-xs text-slate-500">{app.employee_id} â€¢ {app.applicant_designation}</p>
                        </div>
                      </td>
                      <td className="py-4 px-6">
                  ...
                  {employeeSearchResults.map(emp => (
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-500">{emp.employee_id} {emp.designation ? `â€¢ ${emp.designation}` : ''}</p>
                      </div>
                    </button>
                  ))}
                </div>
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              {application.assigned_to_designation && (
                                <p className="text-xs text-gray-600">{application.assigned_to_designation} â€¢ {application.assigned_to_department}</p>
                              )}
                            </div>
                          </div>
                        </div>
                    ...
                    {application.assignees?.length > 0 && (
                      <div className="mb-3 p-2 bg-blue-50 border border-blue-200 rounded-lg">
                        <p className="text-xs text-blue-700">
                          {isMyTurn ? 'ðŸŸ¢ It\'s your turn to review' : 
                           isHrFinalApproval ? 'ðŸŸ¡ Awaiting your HR final approval' :
                           'â³ Waiting for other assignees'}
                        </p>
                      </div>
                    )}
